...
(function (dltk, window) {
    ...
    dltk.Experiment = function Experiment(_$, BrowserDetect, optdct) {
        ...
        var OPTDCT_DEFAULT = {
            ...
            elemSystemmsg: null, elemNotice: null, elemWarning: null, elemPreload: null,
            elemTutorialLink: null, elemTutorial: null, elemTimer: null,
            elemTest: null, elemRespGroup: null, elemBeginTaskBtn: null, elemFPSBench: null,
            elemCanvasTestFPS: undefined,  // <- this default must be undefined
        ...
        var $ = function $(elem) {
            ...
            if (target === null || target.length === 0) {
                ...
                if (dbgMessage) console.log('NOOP: ' + elem);
        ...
        this.testSystemAndPrepExp = function testSystemAndPrepExp() {
            ...
            dltk.runBenchmark(_checkSystem, {canvas_test_fps: o.elemCanvasTestFPS});   // run benchmark...
