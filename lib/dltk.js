...
(function (dltk, window) {
     ...
     *************************************************************************/
    dltk.Experiment = function Experiment(_$, BrowserDetect, optdct) {
        // -- Default constants
        ...
        var BROWSER = (navigator.userAgent.indexOf('Trident/') >= 0) ?
            'Explorer' /*  IE11+ reports as Firefox... */ : BrowserDetect.browser;
        ...
        this.testSystemAndPrepExp = function testSystemAndPrepExp() {
            ...
            dltk.runBenchmark(_checkSystem, {canvas_test_fps: o.elemFPSBenchCanvasID});   // run benchmark...
