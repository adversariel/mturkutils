...
(function (dltk, window) {
    ...
    dltk.Experiment = function Experiment(_$, optdct) {
        ...
        var OPTDCT_DEFAULT = {
            ...
            elemUpperRightGroup: null, elemTutorialLink: null, elemTimer: null,
            elemTutorial: null, elemBeginTaskGroup: null, elemBeginTaskBtn: null, elemFPSBench: null,
            elemSample: null, elemRespGroup: null,
        ...
        this.recomputeOffset = function recomputeOffset() {
            ...
            $(o.elemUpperRightGroup).css('margin-top', offsetToTop + 'px');
