...
(function (dltk, window) {
     ...
     *************************************************************************/
    dltk.Experiment = function Experiment(imgFiles, _$, BrowserDetect, postBeginExp, optdct) {
        // -- Default constants
        ...
        var OPTDCT_DEFAULT = {elemSystemmsg: null, elemNotice: null, elemWarning: null, elemPreload: null,
            elemTutorialLink: null, elemTutorial: null,
        ...
        var $ = function $(elem) {
            ...
            if (target === null || target.length == 0) {
                ...
                return {hide: nop, show: nop, click: nop, html: nop, append: nop, dialog: nop, css: nop};
            }
            return target;
        };
        this.__$ = $;
        ...
        this._beginExp = function _beginExp() {
            this.exp_started = true;
            $(o.elemBeginTaskBtn).hide();
            $(o.elemBeginTaskGroup).hide();
            $(o.elemPreload).hide();
            $(o.elemNotice).hide();
            if (callable(onBeginExp)) postBeginExp();  //primeSystemAndRunTrialOnce();
        };
        ...
        this._afterPassBenchmark = function _afterPassBenchmark() {
            ...
            this.startClock();
            this.showTutorial();
            if (callable(o.postAfterPassBenchmark)) o.postAfterPassBenchmark();
        };

        this._checkSystem = function _checkSystem(benchmark_) {
            ...
            if (!benchmark.api_support) {
                var msg = o.supportedBrowser.join(', ');
        ...
        this.init = function init() {
            ...
            $(o.elemBeginTaskBtn).click(this._beginExp);
            $(o.elemBeginTaskBtn).hide();
            $(o.elemWarning).hide();
