...
(function (dltk, window) {
    ...
    dltk._callHookfunctions = function _callHookfunctions(targets, flags, name, argdct, onFinish) {
        ...
        dltk.runJobsAsync(jobs_async_default, argdct, function (results_async_default) {
            ...
            dltk.runJobsAsync(jobs_async, argdct, function (results_async) {
                ...
                var results = dltk._callHookfunctionsSyncOnly(targets, flags, name, argdct);
    ...
    dltk.Experiment = function Experiment(_$, optdct) {
        ...
        this._callHookfunctions = function _callHookfunctions(name, argdct, onFinish) {
            ...
            dltk._callHookfunctions(targets, flags, name, argdct, onFinish);
        };
        ...
        this._afterPassBenchmark = function _afterPassBenchmark() {
            ...
            that._callHookfunctions('onAfterPassBenchmark', {benchmarks: that.getBenchmarkResults()}, function() {
                if (!o.automaticallyRunPreloadAfterPassBenchmark)
                    return;
                var argdct = {elemPreload: o.elemPreload};
                // Call all preloaing routines one by one...
                that._callHookfunctions('onPreloadRsrcs', argdct, function () {
                    // finished all preloading....
                    that._callHookfunctions('onAfterPreloadAllModulesRsrcs', {}, function () {
        ...
        this.beginExp = function beginExp() {
            ...
            $(o.elemPreload).hide();
            $(o.elemNotice).hide();
            that._callHookfunctions('onBeginExp', {}, function() {
        ...
        this.recomputeOffset = function recomputeOffset() {
            ...
            that._callHookfunctions('onRecomputeOffset', {winW: winW, winH: winH,
        ...
        this.runNextTrial = function runNextTrial() {
            ...
            that._callHookfunctions('onRunNextTrial', argdct);
        };
