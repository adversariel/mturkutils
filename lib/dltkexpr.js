...
dltk._after___callCallbackFunctionsAsync
...
dltk.Experiment = function Experiment(_$, optdct) {
    ...
    // -- Public variables
    this._$ = _$;
    this.o = dltk.applyDefaults(optdct, OPTDCT_DEFAULT);   // shorthand for optdct
...
dltk.Experiment.prototype._after___onAfterPassBenchmark = function _after___onAfterPassBenchmark() {
    if (!this.o.automaticallyRunPreloadAfterPassBenchmark)
        return;
    var argdct = {elemPreload: o.elemPreload};
    // Call all preloaing routines one by one...
    this._callCallbackFunctions('onPreloadRsrcs', argdct, function () {
        // finished all preloading....
        this._callCallbackFunctions('onAfterPreloadAllModulesRsrcs', {}, function () {
...
dltk.Experiment.prototype._afterPassBenchmark = function _afterPassBenchmark() {
    ...
    this._callCallbackFunctions('onAfterPassBenchmark',
            {benchmarks: this.getBenchmarkResults()},
            this._after___onAfterPassBenchmark);
};
...
this.beginExp = function beginExp() {
    ...
    this._callCallbackFunctions('onBeginExp', {}, function() {
        ...
        if (o.automaticallyRunNextTrialOnBeginExp) this.runNextTrial();
    });
};
...
this.testSystemAndPrepExp = function testSystemAndPrepExp() {
    ...
    this._timer_bench = setTimeout(function() {           // ... or fall back to failure mode in 1 min.
        this._checkSystem({api_support: false}); 
        }, 60 * 1000);
};
...
this.startClock = function startClock() {
    ...
    this._timer_disp = setInterval(updateTimer, 1000);
